...
function init() {
    ...
    sidebar.setContent('<h1>Wiki Loves Monuments</h1>' + 
        ...
        '<iframe src="//tools.wmflabs.org/wlm-stats/stats-2018-mini.php" width=330px height=170px frameborder=0 scrolling=no style="margin-bottom: -20px;">Browser not compatible.</iframe>' +
