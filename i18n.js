function translatemsg (msg) {
    ...
    switch (msg) {
       ...
       case 'welcome':
           switch (browserlang) {
               case 'es': msg2 = '<b>¡Bienvenido/a!</b> Este es un mapa para el concurso <a href="' + getwebsite ('es') + '" target="_blank">Wiki Loves Monuments 2019</a>&nbsp;<a href="https://twitter.com/'+gettwitter('es')+'" target="_blank" title="@'+gettwitter('es')+' on Twitter!"><img src="icons/twitter.ico" width="18px" /></a>&nbsp;<a href="'+getfacebook('es')+'" target="_blank" title="Wiki Loves Monuments on Facebook!"><img src="icons/facebook.png" width="18px" /></a>. ¡Busca monumentos próximos a ti, hazles fotos y súbelas!'; break;
               case 'fr': msg2 = '<b>Bienvenue !</b> Ceci est une carte pour le concours photographique <a href="' + getwebsite ('fr') + '" target="_blank">Wiki Loves Monuments 2019</a>&nbsp;<a href="https://twitter.com/'+gettwitter('fr')+'" target="_blank" title="@'+gettwitter('fr')+' on Twitter!"><img src="icons/twitter.ico" width="18px" /></a>&nbsp;<a href="'+getfacebook('fr')+'" target="_blank" title="Wiki Loves Monuments on Facebook!"><img src="icons/facebook.png" width="18px" /></a>. Cherchez monuments proche de vous, prenez des photos et importez-les !'; break;
               case 'he': msg2 = 'ברוכים הבאים! זוהי מפה עבור תחרות הצילום ויקיפדיה אוהבת אתרי מורשת 2019. חפשו אתרי מורשת ועתיקות לידכם, צלמו והעלו את התמונות!'; break;
               case 'it': msg2 = '<b>Welcome!</b> This is a map for the <a href="' + getwebsite ('it') + '" target="_blank">Wiki Loves Monuments 2019</a>&nbsp;<a href="https://twitter.com/'+gettwitter('it')+'" target="_blank" title="@'+gettwitter('it')+' on Twitter!"><img src="icons/twitter.ico" width="18px" /></a>&nbsp;<a href="'+getfacebook('it')+'" target="_blank" title="Wiki Loves Monuments on Facebook!"><img src="icons/facebook.png" width="18px" /></a> photographic contest. Search monuments near to you, take photos and upload them!'; break;
               case 'ka': msg2 = '<b>მოგესალმებით!</b> ეს არის „<a href="' + getwebsite ('ka') + '" target="_blank">ვიკის უყვარს ძეგლები 2019-ის</a>“&nbsp;<a href="https://twitter.com/'+gettwitter('ka')+'" target="_blank" title="@'+gettwitter('ka')+' on Twitter!"><img src="icons/twitter.ico" width="18px" /></a>&nbsp;<a href="'+getfacebook('ka')+'" target="_blank" title="Wiki Loves Monuments on Facebook!"><img src="icons/facebook.png" width="18px" /></a> ძეგლების ამსახველი რუკა. მოძებნეთ ძეგლები თვქენთან ახლოს, გადაუღეთ ფოტოები და გახდით უდიდესი ფოტოკონკურსის მონაწილე!'; break;
               case 'nb': msg2 = 'Velkommen! Dette er et kart for <a href="' + getwebsite ('no') + '" target="_blank">Wiki Loves Monuments 2019</a>-fotokonkurransen&nbsp;<a href="https://twitter.com/'+gettwitter('no')+'" target="_blank" title="@'+gettwitter('no')+' on Twitter!"><img src="icons/twitter.ico" width="18px" /></a>&nbsp;<a href="'+getfacebook('no')+'" target="_blank" title="Wiki Loves Monuments on Facebook!"><img src="icons/facebook.png" width="18px" /></a>. Søk i monumenter nær deg, ta bilder og last dem opp!'; break;
       ...
       case 'september-year':
           switch (browserlang) {
               case 'es': msg2 = 'Septiembre de 2019'; break;
               case 'it': msg2 = 'Settembre 2019'; break;
               case 'ka': msg2 = '2019 წლის სექტემბერი'; break;
               case 'sv': msg2 = 'September 2019'; break;
               
               default: msg2 = 'September 2019';
           }
           break;
